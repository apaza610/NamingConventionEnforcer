...
def CadenaModelo(E1,E2,E3,E4,E5,E6,E7):
    cadena="{}-{}-{}{}{}-{}{}".format(E1,E2,E3,E4,E5,E6,E7)
    borrame = tkinter.Tk()
    borrame.withdraw()
...
def main():
    ...
    E1.insert(0,var1)
    E1.configure({"background":"yellow3"})
    E1.grid(row=2,column=0)
    E2 = tkinter.Entry(raiz, width=20, bd=5)
    E2.insert(0,var2)
    E2.grid(row=2,column=1)
    E3 = tkinter.Entry(raiz, width=20)
    E3.configure({"background":"NavajoWhite2"})
    E3.insert(0,var3)
    E3.grid(row=2,column=2)
    E4 = tkinter.Entry(raiz, width=20, bd=5)
    E4.insert(0,var4)
    E4.configure({"background":"NavajoWhite2"})
    E4.grid(row=2,column=3)
    E5 = tkinter.Entry(raiz, width=20)
    E5.configure({"background":"NavajoWhite2"})
    E5.insert(0,var5)
    E5.grid(row=2,column=4)
    E6 = tkinter.Entry(raiz, width=20, bd=5)
    E6.insert(0,var6)
    E6.configure({"background":"cyan"})
    E6.grid(row=2,column=5)
    E7 = tkinter.Entry(raiz, width=20)
    E7.insert(0,var7)
    E7.configure({"background":"cyan"})
    ...
    tkinter.Label(raiz,text="-Contiene").grid(row=5,column=5)
    ...
    E11.insert(0,var6)
    E11.grid(row=6,column=5) """
    
    tkinter.Button(raiz, text="Material", command=lambda:CadenaMaterial( E1.get(), E2.get(), E4.get(), E6.get() )).grid(row=7,column=0)
    tkinter.Button(raiz, text="Textura",  command=lambda:CadenaTextura(  E1.get(), E2.get(), E4.get(), E6.get() )).grid(row=7,column=1)
